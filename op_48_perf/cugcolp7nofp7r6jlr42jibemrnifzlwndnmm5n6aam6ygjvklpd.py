...
# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/nw/cnwxnotrd4ndumzvmnfxukgp64276wg4utowxoacqxzopus6gjbd.py
...
def triton_red_fused__to_copy_embedding_mean_mul_pow_rsqrt_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tl.device_assert((0 <= tmp16) & (tmp16 < 128256), "index out of bounds: 0 <= tmp16 < 128256")
        tmp18 = tl.load(in_ptr1 + (r0_1 + 4096*tmp16), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tmp28 = tmp12 * tmp27
        tl.store(out_ptr1 + (r0_1 + 4096*x0), tmp28, r0_mask)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/qm/cqmzqqgezt3qskxr45ix5tcwc6ugwau3egg376cvyrflu3y2tk5l.py
...
# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/vx/cvxcu6sapro6lddk4q6bkomy2e3ymv6rlnncqt2aijsb6ihg4y4s.py
...
def triton_poi_fused_add_cat_mul_2(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y1 = yindex // 1024
    x3 = xindex // 128
    tmp0 = tl.load(in_ptr0 + (x5 + 512*y4), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp1 = tl.load(in_ptr1 + (y0 + 1024*((x2 % 64)) + 65536*y1), xmask, eviction_policy='evict_last')
    tmp3 = in_ptr2
    ...
    tmp12 = tmp8 < tmp11
    tmp13 = tl.load(in_ptr0 + (64 + 128*x3 + 512*y4 + (x2)), xmask & tmp12, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp14 = -tmp13
    ...
    tmp19 = tmp8 < tmp18
    tmp20 = tl.load(in_ptr0 + (128*x3 + 512*y4 + ((-64) + x2)), xmask & tmp17, eviction_policy='evict_last', other=0.0).to(tl.float32)
    ...
    tmp25 = tmp21 * tmp24
    tmp26 = tmp7 + tmp25
    tl.store(out_ptr0 + (x5 + 512*y4), tmp26, xmask)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/cr/ccry2vybgx4biwuaxziovzppor3wgmj77za3r3ccm6bvrdmzj222.py
...
def triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_3(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (x2 + 1024*((x0 % 64)) + 65536*x3), None, eviction_policy='evict_last')
    tmp3 = in_ptr2
    tmp2 = tl_math.cos(tmp1)
    tmp4 = tmp3.to(tl.float32)
    tmp5 = tmp2 * tmp4
    ...
    tmp25 = tmp21 * tmp24
    tmp26 = tmp7 + tmp25
    tl.store(out_ptr0 + (x0 + 128*x2 + 131072*x1 + 4194304*x3), tmp26, None)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/zk/czks2ktgymzus3kxs5ogdmjpcomfmbvb76q4rdiozm7n7urb5kqi.py
# Topologically Sorted Source Nodes: [mul_4, cat_1, mul_5, q_embed, query, attn_output], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
# Source node to ATen node mapping:
#   attn_output => _scaled_dot_product_fused_attention_overrideable, full_default_1, full_default_2, where
#   cat_1 => cat
...
def triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_4(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = xindex // 4194304
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 128*(x2 // 8) + 512*x1 + 524288*x3), None).to(tl.float32)
    tl.store(out_ptr0 + (x4), tmp0, None)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/fp/cfpgglccdbvwen22z2evo2abht5ri73txum7th3w4bdqp33u6gzo.py
...
# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/a4/ca4iuhfljla2lwhz32hyo6jlavmizi2oj2bkessy5kzoo2fi3uwc.py
...
def triton_poi_fused_clone_6(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = xindex // 4194304
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 128*x2 + 131072*x1 + 4194304*x3), None).to(tl.float32)
    tl.store(out_ptr0 + (x4), tmp0, None)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/lk/clkuc2c5gnuazp7esxdkrsu4d6nma3oxexxvasgnbkdgcazezflb.py
...
def triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp7 = tl.load(in_ptr2 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp1 = tl.full([XBLOCK, R0_BLOCK], 128256, tl.int32)
        tmp2 = tmp0 + tmp1
        tmp3 = tmp0 < 0
        tmp4 = tl.where(tmp3, tmp2, tmp0)
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp21 = tl.load(in_ptr2 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tmp20 = tl.load(in_ptr1 + (r0_1 + 4096*tmp18), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp22 = tmp20 + tmp21
        tmp23 = tmp22.to(tl.float32)
        tmp24 = 4096.0
        tmp25 = (tmp12 / tmp24)
        ...
        tmp32 = tmp14 * tmp31
        tl.store(out_ptr1 + (r0_1 + 4096*x0), tmp32, r0_mask)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/tp/ctpybnjc5hgaide6wshhksd27krl6cwys5hciu33s4jrpjc7usmn.py
...
# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/vi/cvihbjnpdl2gb7zteol3flnpgg2htsemynmoxyjzxnqgibqqpbyz.py
...
def triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_9(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        r0_1 = r0_index
        tmp7 = tl.load(in_ptr2 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp9 = tl.load(in_ptr3 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp1 = tl.full([XBLOCK, R0_BLOCK], 128256, tl.int32)
        tmp2 = tmp0 + tmp1
        tmp3 = tmp0 < 0
        tmp4 = tl.where(tmp3, tmp2, tmp0)
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp23 = tl.load(in_ptr2 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp25 = tl.load(in_ptr3 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tmp22 = tl.load(in_ptr1 + (r0_1 + 4096*tmp20), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp24 = tmp22 + tmp23
        tmp26 = tmp24 + tmp25
        tmp27 = tmp26.to(tl.float32)
        tmp28 = 4096.0
        ...
        tmp36 = tmp16 * tmp35
        tl.store(out_ptr1 + (r0_1 + 4096*x0), tmp36, r0_mask)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/e3/ce3k3ojskkcubf2drpbzjliux6fser77tdtv4cnd6bvhtxvocd6m.py
...
def triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_10(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp7 = tl.load(in_out_ptr0 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp9 = tl.load(in_ptr2 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp11 = tl.load(in_ptr3 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp1 = tl.full([XBLOCK, R0_BLOCK], 128256, tl.int32)
        tmp2 = tmp0 + tmp1
        tmp3 = tmp0 < 0
        tmp4 = tl.where(tmp3, tmp2, tmp0)
        tl.device_assert((0 <= tmp4) & (tmp4 < 128256), "index out of bounds: 0 <= tmp4 < 128256")
        tmp6 = tl.load(in_ptr1 + (r0_1 + 4096*tmp4), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp8 = tmp6 + tmp7
        tmp10 = tmp8 + tmp9
        tmp12 = tmp10 + tmp11
        ...
        tl.store(in_out_ptr0 + (r0_1 + 4096*x0), tmp12, r0_mask)
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp19 = tl.load(in_out_ptr0 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        ...
        tmp29 = tmp18 * tmp28
        tl.store(out_ptr1 + (r0_1 + 4096*x0), tmp29, r0_mask)
''', device_str='xpu')


# kernel path: /workspace1/xingyuan/20250530-llama31-profiling/torchinductor_cache/u2/cu2ywypmba5gzjxemlawrfbjh6ednfyx2lptwlg3rkzxbapajiqt.py
...
def triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_11(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp0 = tl.load(in_out_ptr0 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp1 = tl.load(in_ptr0 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp2 = tmp0 + tmp1
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp9 = tl.load(in_out_ptr0 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp10 = tl.load(in_ptr0 + (r0_1 + 4096*x0), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp11 = tmp9 + tmp10
        ...
        tmp20 = tmp19.to(tl.float32)
        tmp21 = tmp8 * tmp20
        tl.store(in_out_ptr0 + (r0_1 + 4096*x0), tmp21, r0_mask)
''', device_str='xpu')
...
def call(args):
    ...
    assert_size_stride(arg3_1, (4, 1024), (1024, 1))
    assert_size_stride(arg4_1, (4, 1024), (0, 1))
    ...
    assert_size_stride(arg10_1, (512, 4096), (4096, 1))
    assert_size_stride(arg11_1, (512, 4096), (4096, 1))
    assert_size_stride(arg13_1, (4096, 4096), (4096, 1))
    assert_size_stride(arg14_1, (), ())
    assert_size_stride(arg15_1, (4096, ), (1, ))
    assert_size_stride(arg16_1, (2048, 4096), (4096, 1))
    assert_size_stride(arg17_1, (2048, 4096), (4096, 1))
    assert_size_stride(arg18_1, (4096, 2048), (2048, 1))
    assert_size_stride(arg19_1, (), ())
    assert_size_stride(arg20_1, (4096, ), (1, ))
    assert_size_stride(arg21_1, (4096, 4096), (4096, 1))
    assert_size_stride(arg22_1, (512, 4096), (4096, 1))
    assert_size_stride(arg23_1, (512, 4096), (4096, 1))
    assert_size_stride(arg24_1, (4096, 4096), (4096, 1))
    assert_size_stride(arg25_1, (), ())
    assert_size_stride(arg26_1, (4096, ), (1, ))
    assert_size_stride(arg27_1, (2048, 4096), (4096, 1))
    assert_size_stride(arg28_1, (2048, 4096), (4096, 1))
    assert_size_stride(arg29_1, (4096, 2048), (2048, 1))
    assert_size_stride(arg30_1, (), ())
    assert_size_stride(arg31_1, (4096, ), (1, ))
    assert_size_stride(arg33_1, (128256, 4096), (4096, 1))
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        buf1 = empty_strided_xpu((4, 1024, 4096), (4194304, 4096, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [inputs_embeds, hidden_states, pow_1, variance, rsqrt, hidden_states_1, to_5, hidden_states_2], Original ATen: [aten.embedding, aten._to_copy, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_embedding_mean_mul_pow_rsqrt_0.run(arg0_1, arg1_1, arg8_1, arg7_1.item(), buf1, 4096, 4096, stream=stream0)
        del arg7_1
        del arg8_1
        buf2 = empty_strided_xpu((4096, 4096), (4096, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf1, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg9_1, (4096, 4096), (1, 4096), 0), out=buf2)
        del arg9_1
        buf3 = empty_strided_xpu((4, 1, 1024), (1024, 4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [position_ids_expanded], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_1.run(arg3_1, buf3, 4096, stream=stream0)
        del arg3_1
        buf4 = empty_strided_xpu((4, 64, 1024), (65536, 1024, 1), torch.float32)
        ...
        del arg5_1
        del buf3
        buf5 = empty_strided_xpu((4096, 512), (512, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf1, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg10_1, (4096, 512), (1, 4096), 0), out=buf5)
        del arg10_1
        buf6 = empty_strided_xpu((4, 4, 1024, 128), (524288, 128, 512, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [mul_6, cat_2, mul_7, k_embed], Original ATen: [aten.mul, aten.cat, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_cat_mul_2.run(buf5, buf4, arg6_1.item(), buf6, 4096, 512, stream=stream0)
        buf7 = buf5; del buf5  # reuse
        # Topologically Sorted Source Nodes: [linear_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf1, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg11_1, (4096, 512), (1, 4096), 0), out=buf7)
        del arg11_1
        buf8 = reinterpret_tensor(buf1, (4, 32, 1024, 128), (4194304, 131072, 128, 1), 0); del buf1  # reuse
        # Topologically Sorted Source Nodes: [mul_4, cat_1, mul_5, q_embed, query, attn_output], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_3.run(buf2, buf4, arg6_1.item(), buf8, 16777216, stream=stream0)
        buf9 = reinterpret_tensor(buf2, (4, 32, 1024, 128), (4194304, 131072, 128, 1), 0); del buf2  # reuse
        # Topologically Sorted Source Nodes: [mul_4, cat_1, mul_5, q_embed, query, attn_output], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_4.run(buf6, buf9, 16777216, stream=stream0)
        buf10 = empty_strided_xpu((4, 32, 1024, 128), (4194304, 131072, 128, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [mul_4, cat_1, mul_5, q_embed, query, attn_output], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_4.run(buf7, buf10, 16777216, stream=stream0)
        buf11 = empty_strided_xpu((4, 1, 1024, 1024), (1048576, 1048576, 1024, 1), torch.bfloat16)
        buf34 = empty_strided_xpu((4, 1, 1024, 1024), (1048576, 1048576, 1024, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [mul_4, cat_1, mul_5, q_embed, query, attn_output, mul_13, cat_3, mul_14, q_embed_1, query_1, attn_output_4], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_5.run(arg2_1, arg4_1, buf11, buf34, 4194304, stream=stream0)
        del arg2_1
        del arg4_1
        # Topologically Sorted Source Nodes: [mul_4, cat_1, mul_5, q_embed, query, attn_output], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        ...
        del buf11
        buf13 = buf12[0]
        assert_size_stride(buf13, (4, 32, 1024, 128), (4194304, 131072, 128, 1))
        assert_alignment(buf13, 16)
        del buf12
        buf17 = reinterpret_tensor(buf9, (4, 1024, 32, 128), (4194304, 4096, 128, 1), 0); del buf9  # reuse
        # Topologically Sorted Source Nodes: [attn_output_1], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_6.run(buf13, buf17, 16777216, stream=stream0)
        buf18 = reinterpret_tensor(buf13, (4096, 4096), (4096, 1), 0); del buf13  # reuse
        # Topologically Sorted Source Nodes: [attn_output_3], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf17, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg13_1, (4096, 4096), (1, 4096), 0), out=buf18)
        del arg13_1
        buf20 = reinterpret_tensor(buf17, (4, 1024, 4096), (4194304, 4096, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [inputs_embeds, hidden_states_5, hidden_states_6, pow_2, variance_1, rsqrt_1, hidden_states_7, to_7, hidden_states_8], Original ATen: [aten.embedding, aten.add, aten._to_copy, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_7.run(arg0_1, arg1_1, buf18, arg15_1, arg14_1.item(), buf20, 4096, 4096, stream=stream0)
        del arg14_1
        del arg15_1
        buf21 = empty_strided_xpu((4096, 2048), (2048, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_4], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf20, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg16_1, (4096, 2048), (1, 4096), 0), out=buf21)
        del arg16_1
        buf22 = empty_strided_xpu((4096, 2048), (2048, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_5], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf20, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg17_1, (4096, 2048), (1, 4096), 0), out=buf22)
        del arg17_1
        buf23 = reinterpret_tensor(buf21, (4, 1024, 2048), (2097152, 2048, 1), 0); del buf21  # reuse
        # Topologically Sorted Source Nodes: [silu, mul_10], Original ATen: [aten.silu, aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_silu_8.run(buf23, buf22, 8388608, stream=stream0)
        buf24 = reinterpret_tensor(buf20, (4096, 4096), (4096, 1), 0); del buf20  # reuse
        # Topologically Sorted Source Nodes: [down_proj], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf23, (4096, 2048), (2048, 1), 0), reinterpret_tensor(arg18_1, (2048, 4096), (1, 2048), 0), out=buf24)
        del arg18_1
        buf26 = reinterpret_tensor(buf8, (4, 1024, 4096), (4194304, 4096, 1), 0); del buf8  # reuse
        # Topologically Sorted Source Nodes: [inputs_embeds, hidden_states_5, hidden_states_9, hidden_states_10, pow_3, variance_2, rsqrt_2, hidden_states_11, to_9, hidden_states_12], Original ATen: [aten.embedding, aten.add, aten._to_copy, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_9.run(arg0_1, arg1_1, buf18, buf24, arg20_1, arg19_1.item(), buf26, 4096, 4096, stream=stream0)
        del arg19_1
        del arg20_1
        buf27 = reinterpret_tensor(buf10, (4096, 4096), (4096, 1), 0); del buf10  # reuse
        # Topologically Sorted Source Nodes: [linear_7], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf26, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg21_1, (4096, 4096), (1, 4096), 0), out=buf27)
        del arg21_1
        buf28 = empty_strided_xpu((4096, 512), (512, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_8], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf26, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg22_1, (4096, 512), (1, 4096), 0), out=buf28)
        del arg22_1
        buf29 = empty_strided_xpu((4, 4, 1024, 128), (524288, 128, 512, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [mul_15, cat_4, mul_16, k_embed_1], Original ATen: [aten.mul, aten.cat, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_cat_mul_2.run(buf28, buf4, arg6_1.item(), buf29, 4096, 512, stream=stream0)
        buf30 = buf28; del buf28  # reuse
        # Topologically Sorted Source Nodes: [linear_9], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf26, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg23_1, (4096, 512), (1, 4096), 0), out=buf30)
        del arg23_1
        buf31 = reinterpret_tensor(buf26, (4, 32, 1024, 128), (4194304, 131072, 128, 1), 0); del buf26  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_3.run(buf27, buf4, arg6_1.item(), buf31, 16777216, stream=stream0)
        del arg6_1
        del buf4
        buf32 = reinterpret_tensor(buf27, (4, 32, 1024, 128), (4194304, 131072, 128, 1), 0); del buf27  # reuse
        # Topologically Sorted Source Nodes: [mul_13, cat_3, mul_14, q_embed_1, query_1, attn_output_4], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_4.run(buf29, buf32, 16777216, stream=stream0)
        buf33 = empty_strided_xpu((4, 32, 1024, 128), (4194304, 131072, 128, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [mul_13, cat_3, mul_14, q_embed_1, query_1, attn_output_4], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_fused_attention_overrideable_add_cat_clone_mul_scalar_tensor_where_4.run(buf30, buf33, 16777216, stream=stream0)
        # Topologically Sorted Source Nodes: [mul_13, cat_3, mul_14, q_embed_1, query_1, attn_output_4], Original ATen: [aten.mul, aten.cat, aten.add, aten.clone, aten.scalar_tensor, aten.where, aten._scaled_dot_product_fused_attention_overrideable]
        ...
        del buf34
        buf36 = buf35[0]
        assert_size_stride(buf36, (4, 32, 1024, 128), (4194304, 131072, 128, 1))
        assert_alignment(buf36, 16)
        del buf35
        buf40 = reinterpret_tensor(buf33, (4, 1024, 32, 128), (4194304, 4096, 128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [attn_output_5], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_6.run(buf36, buf40, 16777216, stream=stream0)
        buf41 = reinterpret_tensor(buf36, (4096, 4096), (4096, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [attn_output_7], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf40, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg24_1, (4096, 4096), (1, 4096), 0), out=buf41)
        del arg24_1
        buf42 = reinterpret_tensor(buf18, (4, 1024, 4096), (4194304, 4096, 1), 0); del buf18  # reuse
        buf44 = reinterpret_tensor(buf40, (4, 1024, 4096), (4194304, 4096, 1), 0); del buf40  # reuse
        # Topologically Sorted Source Nodes: [inputs_embeds, hidden_states_5, hidden_states_9, hidden_states_15, hidden_states_16, pow_4, variance_3, rsqrt_3, hidden_states_17, to_11, hidden_states_18], Original ATen: [aten.embedding, aten.add, aten._to_copy, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_embedding_mean_mul_pow_rsqrt_10.run(buf42, arg0_1, arg1_1, buf24, buf41, arg26_1, arg25_1.item(), buf44, 4096, 4096, stream=stream0)
        del arg0_1
        del arg1_1
        del arg25_1
        del arg26_1
        del buf24
        del buf41
        buf45 = reinterpret_tensor(buf23, (4096, 2048), (2048, 1), 0); del buf23  # reuse
        # Topologically Sorted Source Nodes: [linear_11], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf44, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg27_1, (4096, 2048), (1, 4096), 0), out=buf45)
        del arg27_1
        buf46 = buf22; del buf22  # reuse
        # Topologically Sorted Source Nodes: [linear_12], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf44, (4096, 4096), (4096, 1), 0), reinterpret_tensor(arg28_1, (4096, 2048), (1, 4096), 0), out=buf46)
        del arg28_1
        buf47 = reinterpret_tensor(buf45, (4, 1024, 2048), (2097152, 2048, 1), 0); del buf45  # reuse
        # Topologically Sorted Source Nodes: [silu_1, mul_19], Original ATen: [aten.silu, aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_silu_8.run(buf47, buf46, 8388608, stream=stream0)
        del buf46
        buf48 = reinterpret_tensor(buf44, (4096, 4096), (4096, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [down_proj_1], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf47, (4096, 2048), (2048, 1), 0), reinterpret_tensor(arg29_1, (2048, 4096), (1, 2048), 0), out=buf48)
        del arg29_1
        del buf47
        buf50 = buf42; del buf42  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_19, hidden_states_20, pow_5, variance_4, rsqrt_4, hidden_states_21, to_13, hidden_states_22], Original ATen: [aten.add, aten._to_copy, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_11.run(buf50, buf48, arg31_1, arg30_1.item(), 4096, 4096, stream=stream0)
        del arg30_1
        del arg31_1
        del buf48
        buf51 = empty_strided_xpu((4, 128256), (128256, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [logits], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf50, (4, 4096), (4194304, 1), 4190208), reinterpret_tensor(arg33_1, (4096, 128256), (1, 4096), 0), out=buf51)
        del arg33_1
        del buf50
    return (1024 + s22, buf6, buf29, reinterpret_tensor(buf7, (4, 4, 1024, 128), (524288, 128, 512, 1), 0), reinterpret_tensor(buf30, (4, 4, 1024, 128), (524288, 128, 512, 1), 0), reinterpret_tensor(buf51, (4, 1, 128256), (128256, 128256, 1), 0), )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    arg0_1 = rand_strided((4, 1024), (1024, 1), device='xpu:0', dtype=torch.int64)
    arg1_1 = rand_strided((128256, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg2_1 = rand_strided((1024, ), (1, ), device='xpu:0', dtype=torch.int64)
    arg3_1 = rand_strided((4, 1024), (1024, 1), device='xpu:0', dtype=torch.int64)
    arg4_1 = rand_strided((4, 1024), (0, 1), device='xpu:0', dtype=torch.int64)
    ...
    arg8_1 = rand_strided((4096, ), (1, ), device='xpu:0', dtype=torch.bfloat16)
    arg9_1 = rand_strided((4096, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg10_1 = rand_strided((512, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg11_1 = rand_strided((512, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg12_1 = 0
    arg13_1 = rand_strided((4096, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg14_1 = rand_strided((), (), device='cpu', dtype=torch.float64)
    arg15_1 = rand_strided((4096, ), (1, ), device='xpu:0', dtype=torch.bfloat16)
    arg16_1 = rand_strided((2048, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg17_1 = rand_strided((2048, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg18_1 = rand_strided((4096, 2048), (2048, 1), device='xpu:0', dtype=torch.bfloat16)
    arg19_1 = rand_strided((), (), device='cpu', dtype=torch.float64)
    arg20_1 = rand_strided((4096, ), (1, ), device='xpu:0', dtype=torch.bfloat16)
    arg21_1 = rand_strided((4096, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg22_1 = rand_strided((512, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg23_1 = rand_strided((512, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg24_1 = rand_strided((4096, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg25_1 = rand_strided((), (), device='cpu', dtype=torch.float64)
    arg26_1 = rand_strided((4096, ), (1, ), device='xpu:0', dtype=torch.bfloat16)
    arg27_1 = rand_strided((2048, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg28_1 = rand_strided((2048, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
    arg29_1 = rand_strided((4096, 2048), (2048, 1), device='xpu:0', dtype=torch.bfloat16)
    arg30_1 = rand_strided((), (), device='cpu', dtype=torch.float64)
    arg31_1 = rand_strided((4096, ), (1, ), device='xpu:0', dtype=torch.bfloat16)
    arg32_1 = 1
    arg33_1 = rand_strided((128256, 4096), (4096, 1), device='xpu:0', dtype=torch.bfloat16)
